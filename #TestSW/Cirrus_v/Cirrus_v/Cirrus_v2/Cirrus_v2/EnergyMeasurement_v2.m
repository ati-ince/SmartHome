function varargout = EnergyMeasurement_v2(varargin)
%ati' nin malidir.......
% Last Modified by GUIDE v2.5 04-Nov-2013 09:53:18
%%
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @EnergyMeasurement_v2_OpeningFcn, ...
                   'gui_OutputFcn',  @EnergyMeasurement_v2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%%
% --- Executes just before EnergyMeasurement_v2 is made visible.
function EnergyMeasurement_v2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to EnergyMeasurement_v2 (see VARARGIN)
handles.degisken=1;
...
% Choose default command line output for EnergyMeasurement_v2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);
% UIWAIT makes EnergyMeasurement_v2 wait for user response (see UIRESUME)
...
function varargout = EnergyMeasurement_v2_OutputFcn(hObject, eventdata, handles) 
...
toplam=Calibration_Vrms(toplam);
set(handles.text_Result_Vrms,'string',toplam);
...
toplam=Calibration_Irms(toplam);
set(handles.text_Result_Irms,'string',toplam);
...
set(handles.text_Result_P,'string',((toplam_I*toplam_V)/1000) );% hObject    handle to pushbutton_Result_P (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
