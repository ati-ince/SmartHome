...
namespace AmmonitDataToplamaV1
{
    class Ammonit
    {
        ...
        DataBaseSQL database = new DataBaseSQL(); // Burada DataBase ye eklemek icin gerekli baglantilari kurmus olduk.
       ...
       ///////////////////////////////
        ...
        public string GetAmmonitData_Listbox(System.Windows.Forms.ListBox Listbox, ushort registerAddress, ushort numOfRegs)
        {
            ...
            try
            {
                ...
                IPAddress ipAddress = IPAddress.Parse("169.254.164.31");
